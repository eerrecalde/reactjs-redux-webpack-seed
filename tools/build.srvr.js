...
process.env.NODE_ENV = 'server' // this assures the Babel dev config (for hot reloading) doesn't apply

console.log('Generating minified bundle for production SRVR via Webpack. This will take a moment...'.blue)
